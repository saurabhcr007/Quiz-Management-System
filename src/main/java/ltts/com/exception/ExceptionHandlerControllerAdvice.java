...
public class ExceptionHandlerControllerAdvice {
    ...
    public @ResponseBody ExceptionResponse handleTypeMismatchException(final Exception exception,
    ...
    @ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR)
    public @ResponseBody ExceptionResponse handleEmployeeServiceException(final Exception exception,
            final HttpServletRequest request) {
